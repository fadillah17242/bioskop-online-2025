...
class PemesananPolicy
{
    ...
    {
        return $user->can('view_any_pemesanan');
    }
    ...
    {
        return $user->can('view_pemesanan');
    }
    ...
    {
        return $user->can('create_pemesanan');
    }
    ...
    {
        return $user->can('update_pemesanan');
    }
    ...
    {
        return $user->can('delete_pemesanan');
    }
    ...
    {
        return $user->can('delete_any_pemesanan');
    }
